...
```
sudo rpm-ostree rebase --experimental ostree-unverified-registry:ghcr.io/ny5re/bluefusion:latest
```

```
sudo rpm-ostree rebase --experimental ostree-unverified-registry:ghcr.io/ny5re/bluefusion:37
```
...
following command:
    ...
    cosign verify --key cosign.pub ghcr.io/ny5re/bluefusion
